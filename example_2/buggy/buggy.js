...
function parseNote(content) {
    ...
    for (let i = 0; i < strippedCopy.length; i++) {
        ...
        if (match) {
            ...
            contentCopy = contentCopy.replace(strippedCopy[i], anchor);
        }
    }
    return contentCopy;
}
...
This will only take a second, my name is Beth from ABC Realty and I just wanted to thank you for visiting my real estate website <a href='http://<a href='http://buybetterwithbeth.com'>buybetterwithbeth.com</a>'>buybetterwithbeth.com</a> and wanted to see if you had any questions right off the bat? 

ABC Realty
555-123-4567
bethrealtor@fake.com
buybetterwithbeth.com
**/